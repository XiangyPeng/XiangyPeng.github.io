...
- Designed feature extraction and reconstruction pipelines to capture temporal and channel-wise dependencies.
- Implemented post-processing methods to localize defective antennas based on reconstruction error patterns.
- Validated the approach using real radar test-chamber measurements, demonstrating reliable fault detection performance.
